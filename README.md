...
The system combines frontend, backend, and AI logic to simulate a smart public transport assistant that improves travel decision-making.

## 🛠️ Technologies Used
- HTML, CSS, JavaScript  
- Python (Flask)  
- Machine Learning (Scikit-learn)  
- SQLite / JSON (for dataset storage)  
